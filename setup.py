...
long_description = "This package makes the [OPTIC](https://nms.kcl.ac.uk/planning/software/optic.html) planning system available in the [unified_planning library](https://github.com/aiplan4eu/unified-planning) by the [AIPlan4EU project](https://www.aiplan4eu-project.eu/)."

setup(name='up_optic',
      version='0.0.1',
      description='Unified Planning Integration of the OPTIC planning system',
