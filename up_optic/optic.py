...
class opticPDDLPlanner(PDDLPlanner):
    ...
    def _get_cmd(self, domain_filename: str,
        ...
        # optic_executable = os.path.join(os.environ.get('OPTIC_PREFIX'), 'release', 'optic', 'optic-clp')
    ...
    def supports(problem_kind: 'ProblemKind') -> bool:
        return problem_kind <= opticPDDLPlanner.supported_kind()
